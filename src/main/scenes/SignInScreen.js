...
export function SignInScreen({ navigation }) {
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.signInButton} onPress={() => signIn({ username: "elisa.it.29@example.com", password: "14adc9" })}>
          <Text style={styles.buttonText}>Sign in</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.signUpButton} onPress={() => signIn({ username: "elisa.it.29@example.com", password: "14adc9" })}>
